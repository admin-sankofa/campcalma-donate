...
const translations = {
 ...
 message: "Deine Spende wurde erfolgreich verarbeitet. Deine Losnummern wurden an deine E-Mail-Adresse gesendet. Viel Glück!",
    ...
    bisafo: {
      ...
      limit_label: "Limit",
      milestone_300: "💚 300+: NGO nachhaltig, exklusiver Content",
      milestone_300_449: "💛 301–449: Exklusiver Zugang, Events zuerst",
      milestone_450: "💜 450+: Gewinnspiele jeden Monat (z.B. MacBook)",
      status_sustainability: "Nachhaltigkeit erreicht 💚",
      status_exclusive: "Exklusiver Zugang, erste Event-Benachrichtigungen ✨",
...
const MilestoneTracker2 = ({ t }) => {
  const [currentMembers, setCurrentMembers] = useState(380); // Current member count from API
